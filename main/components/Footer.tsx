        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="text-lg font-black tracking-wide uppercase text-red-600">
                Arneg
                <span className="text-white/70">
                  {" "}
                  And <span style={{ color: "#912963" }}>True</span>{" "}
            ...
            <p className="max-w-sm text-sm text-white/75">
              Delivering industry-leading refrigeration and display solutions
              with elegant design and engineering excellence.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="mb-3 text-xs font-bold tracking-widest text-red-600 uppercase">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <address className="not-italic text-sm text-white/70">
              ...
              <Link
                href="/contact"
                className="text-white/70 hover:text-red-500 transition block mt-1"
              >
                Contact page
              </Link>
              <a
              ...
              <a
                href="mailto:info@ilktechnology.com"
                className="text-white/70 hover:text-red-500 transition block mt-1"
              >
                info@ilktechnology.com
              </a>
            </address>
          </div>
        </div>
        ...
        <div className="mt-10 border-t border-white/6 pt-6">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <p className="text-sm text-white/60 flex items-center gap-2">
              <span
                className="inline-block h-1 w-1 rounded-full bg-red-600"
                aria-hidden
              />
