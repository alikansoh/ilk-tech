          ...
          <div className="tbr-bp-wrap">
            ...
            >
              ...
              <g id="bp3-dims" opacity="0">
                ...
                {/* ── Width dimension ── */}
                <line x1="100" y1="468" x2="490" y2="468" stroke="#651641" strokeWidth="0.8" strokeDasharray="3,3" />
                <line x1="100" y1="462" x2="100" y2="474" stroke="#651641" strokeWidth="1" />
                <line x1="490" y1="462" x2="490" y2="474" stroke="#651641" strokeWidth="1" />
                <text x="295" y="485" fontFamily="Space Grotesk,sans-serif" fontSize="12" fill="#651641" textAnchor="middle">
                  1219 mm
                </text>
                <text x="295" y="499" fontFamily="Space Grotesk,sans-serif" fontSize="10" fill="#9e7a8c" textAnchor="middle">
                  width
                </text>

                {/*
                  ── Depth dimension — between the two right-side feet ──
                  Front-right foot bottom centre ≈ (466, 447)
                  Back-right foot bottom centre  ≈ (555, 395)
                  The dimension line runs parallel to the perspective depth axis,
                  offset 14 px to the right of the leg centres so it clears the legs.
                  Tick marks are drawn perpendicular (rotated 90° relative to the line direction).
                  The line direction vector: dx=89, dy=−52  → length≈103
                  Perpendicular unit vector (normalised): (52/103, 89/103) ≈ (0.505, 0.864)
                  Tick half-length = 6 px
                */}
                {/* offset anchor points (+14 px perpendicular right) */}
                {/* front point: (466+14*0.505, 447+14*0.864) ≈ (473, 459) */}
                {/* back  point: (555+14*0.505, 395+14*0.864) ≈ (562, 407) */}
                <line
                  x1="473" y1="459"
                  x2="562" y2="407"
                  stroke="#651641"
                  ...
                  strokeDasharray="3,3"
                />
                {/* Tick at front-right foot end — perpendicular to the depth line */}
                {/* perpendicular direction: (0.505, 0.864) scaled by 6 */}
                <line
                  x1={473 - 0.505 * 6} y1={459 - 0.864 * 6}
                  x2={473 + 0.505 * 6} y2={459 + 0.864 * 6}
                  stroke="#651641"
                  strokeWidth="1"
                />
                {/* Tick at back-right foot end */}
                <line
                  x1={562 - 0.505 * 6} y1={407 - 0.864 * 6}
                  x2={562 + 0.505 * 6} y2={407 + 0.864 * 6}
                  stroke="#651641"
                  strokeWidth="1"
                />
                {/* Label — midpoint of the dimension line, offset further right */}
                <text
                  x="524" y="448"
